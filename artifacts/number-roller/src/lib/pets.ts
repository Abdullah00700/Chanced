...
export const PETS: PetDef[] = [
...

  {
    ...
    baseRarity: "epic",
    effect: { coinMult: 1.6, rarityTilt: 0.3, bossDamageMult: 1.3 },
    flavor: "+60% coins, +0.3 rarity tilt, +30% boss damage.",
    art: "thunder-serpent",
    costCoins: 150_000,
    costGems: 200,
    source: "shop",
  },
  {
    ...
    flavor: "50% faster rolls. Every 20s, skips 5s of hatch time.",
    art: "time-keeper",
    costCoins: 600_000,
    costGems: 800,
    source: "shop",
  },
  {
    ...
    name: "Nebula Stalker",
    baseRarity: "legendary",
    effect: { rarityTilt: 0.8, coinMult: 1.8 },
    flavor: "+0.8 rarity tilt and +80% coins. Hunts from the nebula.",
    art: "nebula-stalker",
    costCoins: 500_000,
    costGems: 1_000,
    source: "shop",
  },
  {
    ...
    flavor: "+200% XP. Rises from crystal, dropping 10,000 coins every 30s.",
    art: "crystal-phoenix",
    costCoins: 1_500_000,
    costGems: 3_000,
    source: "shop",
  },
  {
    ...
    name: "Void Hydra",
    baseRarity: "mythic",
    effect: { coinMult: 3.5, xpMult: 2.2, bossDamageMult: 2.5 },
    flavor: "Three heads of pure void. +250% coins, +120% XP, ×2.5 boss damage.",
    art: "void-hydra",
    costCoins: 2_000_000,
    costGems: 5_000,
    source: "shop",
